...
#WHUT THE FUCK HAPPENED HERE
#We said goodbye to Bayesian Stats????

#Linear Model
lol <- lm(VerbalIQ ~ ADOS, data)

#VerbalIQ
lol1 <- ggplot(data, aes(x=VerbalIQ, y= ADOS, color=ASD))+geom_point()+geom_smooth(method = "lm",aes(group = ASD)) + geom_smooth(method = "lm", formula = y ~ x)
